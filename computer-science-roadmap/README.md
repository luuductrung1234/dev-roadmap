...
**Practice Place**:
[Practice with Math](https://www.khanacademy.org/math)
...
[Calculus 1A](https://www.edx.org/course/calculus-1a-differentiation-mitx-18-01-1x-0), [Calculus 1B](https://www.edx.org/course/calculus-1b-integration-mitx-18-01-2x-0), [Calculus 1C](https://www.edx.org/course/calculus-1c-coordinate-systems-infinite-mitx-18-01-3x-0) _(optional)_ | 39 weeks | 5-10 hours/weeks | learn these 3 in the order
...
[Introduction to Discrete Mathematics for CS](https://www.coursera.org/specializations/discrete-mathematics) | 20 weeks | 5 hours/week | single variable calculus (Calculus Two)
...
`some article that you may get more information`
  ...
  * [Sort Algorithms Animations](https://www.toptal.com/developers/sorting-algorithms)
...
- [Cybersecurity specialization list](https://www.coursera.org/browse/computer-science/computer-security-and-networks?languages=en) in Coursera
- [Android Developer Nanodegree](https://www.udacity.com/course/android-developer-nanodegree-by-google--nd801) by Google
- [Software Product Management specialization](https://www.coursera.org/specializations/product-management) by Coursera
- [Agile Development specialization](https://www.coursera.org/specializations/agile-development) by Coursera
...
## :chart_with_upwards_trend: How to show your progress
